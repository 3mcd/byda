...
;(function() {
	...
	byda.get = function(string) {
		var dom = string ? new DOMParser().parseFromString(string, 'text/html') : document;
		return dom.querySelectorAll(getSelector());
	};
