...
;( function ( root, factory ) {
    ...
    function byda( options, callback ) {
        ...
        if ( imports && supportsImports && !options.imp ) {
    ...
    function request( options ) {
        ...
        // file found.
        if ( !file || options.imp ) return success( null, options );
    ...
    function success( response, options ) {
        var sim = cache[ options.file ] || byda.flash ( {
            dom: response || options.imp
        } );
     ...
     */
    function Store( name, value, transition ) {
        this.name = name;
        this.list = [];
    ...
    byda.init = function( options ) {
        ...
        transitions  = options.transitions || transitions; // transitions object.
        imports     = options.imports;                  // Use HTML imports instead of XHR.
        base        = options.base;                     // Set the base variable to a file path string.
        complete    = options.complete || noop;         // A global complete callback.
    };
