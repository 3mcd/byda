...
* Flash#changes array: Contains a list of all changes generated by Flash#compare.
* Flash#commit function: Perform the changes.
* Flash#compare function(flash): Compare flash with another flash to generate an array of changes stored in Flash#changes.
* Flash#condense function: Returns a condensed organization of byda elements.
* Flash#elements object: An organization of byda elements on the page.
* Flash#list array: Contains a list of all byda elements on the page. Generated when the Flash is created.
* Flash#organize function(list): Organize all elements from the array Flash#list or an array specified in the first parameter.
