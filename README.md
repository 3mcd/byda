...
* Flash#changes __array__: Contains a list of all changes generated by Flash#compare.
* Flash#commit __function__: Perform the changes.
* Flash#compare __function__(flash): Compare flash with another flash to generate an array of changes stored in Flash#changes.
* Flash#condense __function__: Returns a condensed organization of byda elements.
* Flash#elements __object__: An organization of byda elements on the page.
* Flash#list __array__: Contains a list of all byda elements on the page. Generated when the Flash is created.
* Flash#organize __function__(list): Organize all elements from the array Flash#list or an array specified in the first parameter.
